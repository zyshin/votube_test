...
var DEFINITIONS = [
    ...
    '保释', '宴会', '遗赠', '臭小子', '烤；烤肉', '不受影响的\n不能透过的', '残疾人；致残', '狂热行为', '车站；仓库', '糖尿病', '独裁；专政', '故意破坏', '犹豫', '空的', '狗舍', '姜', '福音', '呻吟；叹气', '争吵；烦扰', '美食家', '预感', '傻瓜', '沉溺\n纵容', '步兵', '低等的', '奖品；战利品', '企业集团', '佯攻', '令人厌恶的', '垄断\n独有', '抵押；贷款', '猛攻', '排', '戳\n露出\n(~around)闲逛', '门廊；走廊', '恶作剧', '布道；宣扬；说教', '挑衅\n引起', '浣熊', '休庭\n深处', '遣返', '道德良知；顾忌', '观点\n感情', '倾斜的', '偷偷的', '统治权；统治者', '样本', '猜测；推测\n做投机买卖', '刺\n使疼痛', '口吃', '传票；传唤', '塞入；夹入'
];
